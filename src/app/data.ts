...
export const fallbackColorways: Colorway[] = [
  { id: "black", label: "Black", swatch: "#161616", image: "/product-assets/colorway-black.png" },
  { id: "heather-grey", label: "Heather Grey", swatch: "#9a9a9a", image: "/product-assets/colorway-gray-chine.png" },
  { id: "beige", label: "Beige", swatch: "#d9c9a8", image: "/product-assets/colorway-beige.png" },
  { id: "navy", label: "Navy", swatch: "#1b2a44", image: "/product-assets/colorway-navy.png" },
  { id: "dark-olive", label: "Dark Olive", swatch: "#3a3a28", image: "/product-assets/colorway-olive-dark.png" },
  { id: "hot-pink", label: "Hot Pink", swatch: "#ec2c7d", image: "/product-assets/colorway-hot-pink.png" },
  { id: "light-pink", label: "Light Pink", swatch: "#f5c8d6", image: "/product-assets/colorway-light-pink.png" },
  { id: "light-blue", label: "Light Blue", swatch: "#cfe8f5", image: "/product-assets/colorway-light-blue.png" },
];
