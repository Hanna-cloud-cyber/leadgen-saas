        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          {isEmpty ? (
            <div className="h-full flex flex-col items-center justify-center text-center text-neutral-500 gap-2">
              ...
              <p className="text-sm">Add a Cloudpetal essential to get started.</p>
            </div>
          ) : (
        ...
        {!isEmpty && (
          <div className="border-t border-neutral-200 px-5 py-4">
            ...
            <a
              ...
              className="block w-full text-center bg-[#3f5b45] text-white font-bold tracking-wide py-3.5 hover:bg-[#324a39] transition-colors"
            >
              CHECKOUT
            </a>
